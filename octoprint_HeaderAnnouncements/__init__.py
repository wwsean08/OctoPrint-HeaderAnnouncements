...
class HeaderAnnouncementsPlugin(octoprint.plugin.SettingsPlugin,
    ...
    def get_assets(self):
        ...
        # core UI here.
        return {
            "js": ["js/HeaderAnnouncements.js"],
            "css": ["css/HeaderAnnouncements.css"],
    ...
    def get_update_information(self):
        ...
        return {
            "HeaderAnnouncements": {
                "displayName": "Headerannouncements Plugin",
                "displayVersion": self._plugin_version,

                # version check: github repository
                "type": "github_release",
                "user": "wwsean08",
                "repo": "OctoPrint-HeaderAnnouncements",
                "current": self._plugin_version,

                # update method: pip
                "pip": "https://github.com/wwsean08/OctoPrint-HeaderAnnouncements/archive/{target_version}.zip",
            }
        }
...
__plugin_name__ = "Header Announcements Plugin"
...
def __plugin_load__():
    ...
    __plugin_implementation__ = HeaderAnnouncementsPlugin()
